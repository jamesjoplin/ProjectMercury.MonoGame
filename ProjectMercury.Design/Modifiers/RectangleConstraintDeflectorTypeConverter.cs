        ...
        public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes)
        {
            ...
            return new PropertyDescriptorCollection(new PropertyDescriptor[]
            {
                new SmartMemberDescriptor(type.GetField("Position"),
                    ...
                    new DescriptionAttribute("The triggerPosition of the rectangle boundary.")),

                new SmartMemberDescriptor(type.GetProperty("Width"),
                    new DescriptionAttribute("The width of the rectangle boundary."),
                    new DisplayNameAttribute("Width")),

                new SmartMemberDescriptor(type.GetProperty("Height"),
                    new DescriptionAttribute("The height of the rectangle boundary."),
                    new DisplayNameAttribute("Height")),

                new SmartMemberDescriptor(type.GetProperty("RestitutionCoefficient"),
                    new DescriptionAttribute("The restitution coefficient of particles when they hit the boundary of the deflector."),
                    new DisplayNameAttribute("Restitution Coefficient")),
            });
        }
    }
}