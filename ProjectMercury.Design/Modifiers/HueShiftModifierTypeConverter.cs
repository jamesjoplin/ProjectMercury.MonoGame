...
namespace ProjectMercury.Design.Modifiers
{
    ...
    public class HueShiftModifierTypeConverter : ExpandableObjectConverter
    {
        /// <summary>
        ...
        {
            var type = typeof(HueShiftModifier);

            return new PropertyDescriptorCollection(new PropertyDescriptor[]
            {
                new SmartMemberDescriptor(type.GetField("HueShift"),
                    new DisplayNameAttribute("Hue Shift"),
                    new DescriptionAttribute("The amount of hue adjustment measured in degrees per second.")),
            });
        }
    }
}