...
namespace ProjectMercury.Design.Modifiers
{
    ...
    public class DampingModifierTypeConverter : ExpandableObjectConverter
    {
        /// <summary>
        ...
        {
            var type = typeof(DampingModifier);

            return new PropertyDescriptorCollection(new PropertyDescriptor[]
            {
                new SmartMemberDescriptor(type.GetField("DampingCoefficient"),
                    new DisplayNameAttribute("Damping Coefficient"),
                    new DescriptionAttribute("The amount the particles should be slowed."))
            });
        }
    }
}