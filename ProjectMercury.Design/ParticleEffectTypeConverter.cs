        ...
        public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes)
        {
            ...
            return new PropertyDescriptorCollection(new PropertyDescriptor[]
            {
                new SmartMemberDescriptor(type.GetProperty("Name"),
                    new DescriptionAttribute("The name of the ParticleEffect.")),

                new SmartMemberDescriptor(type.GetField("Author"),
                    new DescriptionAttribute("The author of the ParticleEffect.")),

                new SmartMemberDescriptor(type.GetField("Description"),
                    new DescriptionAttribute("The desription of the ParticleEffect."))
            });
        }
    }
}