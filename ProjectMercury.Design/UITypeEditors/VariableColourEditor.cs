...
namespace ProjectMercury.Design.UITypeEditors
{
    ...
    public class VariableColourEditor : ColorEditor
    {
        /// <summary>
        ...
        {
            var xnaColour = (VariableFloat3)value;
            ...
            if (provider != null)
            {
                ...
                this.StartColourPicker(edSvc, Colour.FromArgb(1, (int)(xnaColour.Value.X * 255f),
                                                                 (int)(xnaColour.Value.Y * 255f),
                                                                 (int)(xnaColour.Value.Z * 255f)));
        ...
        {
            if (e.Value is VariableFloat3)
            {
                var colour = (VariableFloat3)e.Value;

                var displayColor = Colour.FromArgb((int)(colour.Value.X * 255f),
                                                   (int)(colour.Value.Y * 255f),
                                                   (int)(colour.Value.Z * 255f));
