...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    public class OpacityInterpolatorPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        public string Name
        {
            get { return "Opacity Interpolator"; }
        }
        ...
        {
            get { return "A Modifier which gradually changes the opacity of a Particle over its lifetime."; }
        }
