...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    public class ScaleMergeModifierPlugin : IModifierPlugin
    {
        ...
        {
            get { return "a Modifier which merges the scale of particles towards a single scale over their lifetime. Works best when Particles are being released with a random scale, where you require the particles to have a uniform scale at the end of their lifetime."; }
        }
