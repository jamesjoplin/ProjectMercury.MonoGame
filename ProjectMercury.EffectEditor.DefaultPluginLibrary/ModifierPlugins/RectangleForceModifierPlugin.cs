...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.Modifiers
{
    ...
    public class RectangleForceModifierPlugin : IModifierPlugin
    {
        ...
        public string Name
        {
            get { return "Rectangle Force Modifier"; }
        }
        ...
        {
            get { return "A Modifier which applies a force to a Particle when it enters a rectangular area."; }
        }
