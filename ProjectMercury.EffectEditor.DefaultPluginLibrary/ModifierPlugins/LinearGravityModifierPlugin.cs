...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    public class LinearGravityModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        public string Name
        {
            get { return "Linear Gravity Modifier"; }
        }
        ...
        {
            get { return "A Modifier that applies a constant force vector to Particles over their lifetime."; }
        }
