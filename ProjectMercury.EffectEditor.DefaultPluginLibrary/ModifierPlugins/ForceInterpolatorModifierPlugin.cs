...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins {
    ...
    public class ForceInterpolatorModifierPlugin : IModifierPlugin {
        /// <summary>
        /// Gets the name of the plugin.
        /// </summary>
        public string Name {
            get { return "Force Interpolator"; }
        }
        ...
        public string Description {
            get { return "A Modifier which adjusts a force applied on a Particle over its lifetime."; }
        }
        ...
        public Modifier CreateDefaultInstance() {
            ...
            ForceInterpolatorModifier a = new ForceInterpolatorModifier();
