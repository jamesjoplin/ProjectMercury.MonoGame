...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    /// <summary>
    /// Defines a plugin which provides OpacityFastFadeModifier support to the EffectEditor.
    /// </summary>
    [Export(typeof(IModifierPlugin))]
    public class OpacityFastFadeModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        {
            get { return "A Modifier which fades the opacity of particles from one to zero."; }
        }
