...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    public class ScaleOscillatorPlugin : IModifierPlugin
    {
        ...
        {
            get { return "A Modifier which adjusts the scale of Particles based on a sine wave."; }
        }
