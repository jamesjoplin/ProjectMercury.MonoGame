...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    public class ScaleInterpolatorPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        {
            get { return "A Modifier which gradually changes the scale of a Particle over its lifetime."; }
        }
