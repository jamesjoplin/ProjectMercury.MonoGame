...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    public class TrajectoryRotationModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        public string Name
        {
            get { return "Trajectory Rotation Modifier"; }
        }
        ...
        {
            get { return "A Modifier which adjusts the rotation of a Particle to follow its trajectory."; }
        }
