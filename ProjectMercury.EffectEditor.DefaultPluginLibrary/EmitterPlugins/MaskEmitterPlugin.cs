...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.Emitterplugins
{
    ...
    public class MaskEmitterPlugin : IEmitterPlugin
    {
        /// <summary>
        ...
        {
            get { return "An Emitter which releases Particles based on a mask pattern."; }
        }
        ...
        public Emitter CreateDefaultInstance()
        {
            return new MaskEmitter
            {
                ...
                Mask = new byte[8][]
                {
                    ...
                    new byte[8] { 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00 },
                    new byte[8] { 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x00 },
                    new byte[8] { 0x00, 0xFF, 0x00, 0xFF, 0xFF, 0x00, 0xFF, 0x00 },
                    new byte[8] { 0x00, 0xFF, 0x00, 0xFF, 0xFF, 0x00, 0xFF, 0x00 },
                    new byte[8] { 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x00 },
                    new byte[8] { 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00 },
                    new byte[8] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
